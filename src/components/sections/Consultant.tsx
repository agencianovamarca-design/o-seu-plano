          ...
          <div className="bg-surface/80 backdrop-blur-md p-10 lg:p-16 flex flex-col justify-center">
            <AnimateIn>
              ...
              <h2 className="font-heading text-[clamp(2rem,4vw,3.5rem)] font-extrabold text-white leading-[0.95] mb-8">
                Estratégia.{" "}
                <span className="text-gradient-gold italic">Decisão.</span>
                <br />
                Resultado.
              </h2>
            </AnimateIn>
            ...
            <AnimateIn delay={0.15}>
              <p className="text-white/40 text-base leading-relaxed mb-6">
                ...
                personalizada e comprometida com o seu objetivo. Não somos
                vendedores — somos estrategistas do seu patrimônio.
              </p>
              <p className="text-white/40 text-base leading-relaxed mb-10">
                Estudamos cada cenário, comparamos cada número e apresentamos a
                verdade que o mercado tradicional não quer que você saiba. Porque
                informação é poder — e poder é liberdade.
              </p>
            </AnimateIn>
            ...
            <AnimateIn delay={0.25}>
              <div className="grid grid-cols-3 gap-4 mb-10">
                {[
                  { label: "Análise", desc: "Personalizada" },
                  { label: "Estratégia", desc: "Sob medida" },
                  { label: "Resultado", desc: "Comprovado" },
                ].map((item) => (
                  <div
                    key={item.label}
