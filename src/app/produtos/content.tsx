...
const products = [
  {
    ...
    features: [
      ...
      "Não ter Google Meu Negócio: o cliente que passa sem parar",
      "WhatsApp pessoal para negócios: o erro que parece solução",
      "Sem identidade visual: por que você é esquecido na hora de indicar",
      "Checklist final: sua empresa está pronta para o digital?",
    ],
    price: "Grátis",
    priceNote: "Baixe agora sem compromisso",
    cta: "Baixar grátis",
    hotmartUrl: "/downloads/ebook-7erros-clientes.pdf",
    isExternal: false,
    highlight: false,
  },
  {
